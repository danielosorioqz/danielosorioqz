...
* 🧪 Testing: Manual Testing, Regression, Smoke, Exploratory, Integration
* 🤖 Automation: Selenium + Python
* 🔗 API Testing: Postman
* 🗄️ Databases: SQL
* 📋 Management: Jira
* 🌐 Tools: GitHub, DevTools, PyCharm, Figma
* 📱 Mobile Testing: Android Studio, Xcode

🚀 Currently improving my skills in test automation, API testing, and software quality engineering.
